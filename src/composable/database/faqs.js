export const faqs = [
    ...
    },
    {
        ...
        answer: `All our instructors are being paid in our <u>revenue-sharing scheme.</u> We offer two revenue-sharing models:
        <ul>
    ...
    {
        question: "Are there any prerequisites to join the programme?",
    ...
    },
    {
        ...
        answer: `Yes. Our part-time courses are designed to <u>fit in the schedules of professionals</u> with full-time work commitments. In addition, our M1 courses are self-recorded and online, hence you can <u>learn at your own pace</u> from anywhere and everywhere that is convenient for you.
            <br/><br/>
    ...
    {
        question:
            "Do I need to have a diploma or an undergraduate degree to join TalentLabs?",
        answer: `Our programme is <u>open and inclusive to everyone</u> regardless of their educational background. While having a degree is not a requirement, a strong academic track record will be looked upon favorably by our admissions team.`,
        type: "course-ca-admissions",
    },
    {
        question: "What is the application process?",
    ...
    {
        question:
            "Are there any prerequisites to join this Certified Associate programme?",
        answer: `Basic knowledge in programming is not required to join this programme. However, we strongly recommend students to complete the relevant M1 courses before enrolling in this programme.
        <br/><br/>
        ...
        The selection process is rigorous. We will select the best candidates based on their application and performance in online assessment tests. For the detailed steps of the application process, please refer to our online application form. Please contact our team to discuss your background and learning goals. We will advise you if this course will be a good fit for you.`,
        type: "course-ca-admissions",
    },
    {
        question: "What will I learn as part of the programme?",
        answer: `Our program's goal is to help you get a well-paying and rewarding job as a software developer. Our curriculum covers basics from programming languages(Python & JavaScript), HTML, CSS, data structures, to modern development technologies like React, Node.js and various web/app development frameworks.
        <br/><br/>
    ...
    {
        question:
            "Why does your course last 6 months when there are other providers offering 6 week coding bootcamp?",
        answer: `We believe that 6 week bootcamp is not enough to help you build a solid foundation for a career in technology. As such, our intensive 6-month programme is designed specifically to ensure that you'll have all the right skill sets that can help you not only secure your dream job, but also to do well once you are on it!`,
        type: "course-ca-programme",
    },
    {
        question: "What is the cost of the programme?",
        ...
        *Available in selected countries only. We are trying our best to introduce ISA to new locations as soon as possible!`,
        type: "course-ca-financing",
    },
    {
        question: "What if I don't get a job or the job does not pay enough?",
        answer: `In the event student earns below the minimum threshold per month, students are only required to pay a very low fixed repayment of around USD $50-100* per month for a period of 120 months.
        <br/><br/>
    ...
    {
        question: "Does the job need to be in technology?",
        answer: `There are no requirements stipulating the nature or type of employment that students choose as different students have different career goals and objectives before enrolling in our programmes. Students will be required to make the ISA monthly payments regardless of job type or industry they manage to enrol in. However, it is our priority to help you secure a role in tech if that is your career objective. Our Career Services team will do their very best to help students to secure their dream job.`,
        type: "course-ca-financing",
    },
    {
        question: "How do you verify my income?",
        answer: `Our Income Sharing Agreement (ISA) requires you to report your job status and income to use. This will be done seamlessly through our platform. After securing your role and you have started your work, you will need to provide us one of the following:
        <ol>
    ...
    {
        question: "Are there any interest rates?",
        answer: `As ISAs are not loans, there will be no interest rates charged.`,
        type: "course-ca-financing",
    },
    {
        question: "When would the payments be collected?",
        answer: "We will collect payments on the 1st of every month. You can also check your payment schedules and amount of payment left through our platform.",
        type: "course-ca-financing",
    },
    {
        question: "What happens to my tuition if I withdraw from TalentLabs?",
        answer: `We reduce the total obligation for people who leave TalentLabs, based on completion of modules. If you withdraw or are withdrawn between module 1 and the end of module 5, you will be responsible for a pro-rata portion of your tuition and receive a refund for applicable amounts paid in advance. If you withdraw or are withdrawn after you complete module 5, you will be responsible for 100% of your tuition.`,
        type: "course-ca-financing",
    },
    {
        question: "Will TalentLabs help me secure a job?",
        answer: `Yes, we will do our very best to help you <u>secure your dream job.</u> However, it is important to keep in mind that there is no way we can do that if you do not contribute your effort to the process as well.
        <br/>
        <br/>
        ...
        type: "course-ca-careers",
    },
    {
        question: "What does the Career Services team do?",
        answer: `Our team will work with you on a number of things, such as:
        <ol>
    ...
    },
    {
        ...
        `,
        type: "course-ca-others",
    },
    {
        question: "Where is TalentLabs located?",
        answer: `TalentLabs is located in Hong Kong but all of our classes take place entirely online. However, we do host local meetups and gatherings across various cities in Asia. Students do not work out of our offices, and can take classes from anywhere.`,
        type: "course-ca-others",
    },
];
