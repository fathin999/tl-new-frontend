<script setup>
import IconOnline from "@/components/icons/courses/IconOnline.vue";
import IconInstructor from "@/components/icons/courses/IconInstructor.vue";
...
const getBanner = (banner) => {
    return new URL(
        `/src/assets/courses/course-banner-${banner}.png`,
        import.meta.url
    );
};
...
const getBadge = (badge) => {
    return new URL(
        `/src/assets/courses/course-badge-${badge}.png`,
        import.meta.url
    );
};
...
const getLogo = (logo) => {
    return new URL(
        `/src/assets/courses/course-provider-${logo}.png`,
        import.meta.url
    );
};
</script>
