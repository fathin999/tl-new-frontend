...
const getLogo = () => {
    return new URL(
        `/src/assets/database/courses/course-provider-${props.providerLogo}.png`,
        import.meta.url
    );
};
...
const getBadge = () => {
    return new URL(
        `/src/assets/database/courses/course-badge-${props.badge}.png`,
        import.meta.url
    );
};
...
const getBanner = () => {
    return new URL(
        `/src/assets/database/courses/course-banner-${props.banner}.png`,
        import.meta.url
    );
};
</script>
...
<template>
    <a class="courses-item" :href="`/courses/${id}`">
