<script setup>
import ArrowLink from "@/components/landing/button/ArrowLink.vue";
import CoursesListSlider from "@/components/landing/courses/CoursesListSlider.vue";
import IconChevron from "@/components/landing/icons/IconChevron.vue";
import IconArrow from "@/components/landing/icons/IconArrow.vue";
...
const filterCourses = () => {
    ...
    return filterFromASetOfCourses(props.courses, "role", role);
};
